...
const Sidebar: React.FC<SidebarProps> = ({ collapsed = false }) => {
  ...
  return (
    <div className={`h-screen bg-white ${collapsed ? 'w-16' : 'w-60'} fixed left-0 flex flex-col shadow-sm transition-all duration-300`}>
      <div className="p-4">
        <h1 className={`text-xl font-extrabold text-blue-500 ${collapsed ? 'hidden' : 'block'}`}>DashStack</h1>
        {collapsed && <MenuIcon className="mx-auto text-blue-500" size={24} />}
      </div>
      ...
      <div className="flex flex-col flex-1 overflow-y-auto">
            ...
            <>
              <div className="flex justify-center py-2.5">
                <Link href="/dashboard">
                  <BarChart3 
                    size={18} 
                    className={pathname === '/dashboard' ? 'text-blue-500' : 'text-gray-800 hover:text-blue-500'} 
                  />
                </Link>
              </div>
              <div className="flex justify-center py-2.5">
                <Link href="/dashboard/products">
                  <ShoppingBag 
                    size={18} 
                    className={pathname === '/dashboard/products' ? 'text-blue-500' : 'text-gray-800 hover:text-blue-500'} 
                  />
                </Link>
              </div>
              <div className="flex justify-center py-2.5">
              ...
              <div className="flex justify-center py-2.5">
                <Link href="/dashboard/inbox">
                  <Inbox 
                    size={18} 
                    className={pathname === '/dashboard/inbox' ? 'text-blue-500' : 'text-gray-800 hover:text-blue-500'} 
                  />
                </Link>
              </div>
              <div className="flex justify-center py-2.5">
                <Link href="/dashboard/orders">
                  <FileText 
                    size={18} 
                    className={pathname === '/dashboard/orders' ? 'text-blue-500' : 'text-gray-800 hover:text-blue-500'} 
                  />
                </Link>
              </div>
              <div className="flex justify-center py-2.5">
                <Link href="/dashboard/stock">
                  <ShoppingBag 
                    size={18} 
                    className={pathname === '/dashboard/stock' ? 'text-blue-500' : 'text-gray-800 hover:text-blue-500'} 
                  />
                </Link>
              </div>
            </>
        ...
        <div className={`${collapsed ? 'hidden' : 'px-4 opacity-60 mb-2'}`}>
          <span className="text-xs font-bold tracking-wider text-gray-800">PAGES</span>
        </div>
            ...
            <>
              ...
              <div className="flex justify-center py-2.5">
                <Link href="/dashboard/contact">
                  <MessageSquare 
                    size={18} 
                    className={pathname === '/dashboard/contact' ? 'text-blue-500' : 'text-gray-800 hover:text-blue-500'} 
                  />
                </Link>
              </div>
              <div className="flex justify-center py-2.5">
                <Link href="/dashboard/invoice">
                  <CreditCard 
                    size={18} 
                    className={pathname === '/dashboard/invoice' ? 'text-blue-500' : 'text-gray-800 hover:text-blue-500'} 
                  />
                </Link>
              </div>
              <div className="flex justify-center py-2.5">
              ...
              <div className="flex justify-center py-2.5">
                <Link href="/dashboard/team">
                  <User2 
                    size={18} 
                    className={pathname === '/dashboard/team' ? 'text-blue-500' : 'text-gray-800 hover:text-blue-500'} 
                  />
                </Link>
              </div>
            </>
            ...
            <>
              <div className="flex justify-center py-2.5">
                <Link href="/dashboard/settings">
                  <Settings 
                    size={18} 
                    className={pathname === '/dashboard/settings' ? 'text-blue-500' : 'text-gray-800 hover:text-blue-500'} 
                  />
                </Link>
              </div>
